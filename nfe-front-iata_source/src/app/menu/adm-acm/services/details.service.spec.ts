...
describe('DetailsService', () => {
  ...
  const _ReasonService = jasmine.createSpyObj<ReasonService>('ReasonService', ['get', 'setBaseURL']);
  _ReasonService.get.and.returnValue(Observable.of({}));
  _ReasonService.setBaseURL.and.returnValue(Observable.of({}));
