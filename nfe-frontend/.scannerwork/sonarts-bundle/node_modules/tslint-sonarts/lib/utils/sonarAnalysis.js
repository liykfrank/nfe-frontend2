...
class IssueLocation {
    constructor(start, end, sourceFile, message) {
        ...
        this.message = message;
        const startPosition = navigation_1.lineAndCharacter(start, sourceFile);
        const endPosition = navigation_1.lineAndCharacter(end, sourceFile);
...
class SonarIssue extends tslint.RuleFailure {
    ...
    addSecondaryLocation(secondaryLocation) {
