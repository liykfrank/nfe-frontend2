...
class Visitor extends sonarAnalysis_1.SonarRuleVisitor {
    ...
    isAdjacent(comment, currentGroup) {
        const groupLine = navigation_1.lineAndCharacter(currentGroup[currentGroup.length - 1].end, this.sourceFile).line;
        const commentLine = navigation_1.lineAndCharacter(comment.pos, this.sourceFile).line;
