...
class Visitor extends sonarAnalysis_1.TypedSonarRuleVisitor {
    ...
    isArrayWithSpreadExpressionOnly(expression, variable) {
        if (nodes_1.isArrayLiteralExpression(expression)) {
            const { elements } = expression;
            if (elements.length === 1 && nodes_1.isSpreadElement(elements[0])) {
                return areEquivalent_1.default(elements[0].expression, variable);
            }
        }
        return false;
    }
