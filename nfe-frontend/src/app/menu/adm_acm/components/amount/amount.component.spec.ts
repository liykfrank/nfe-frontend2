...
describe('AmountComponent', () => {
  ...
  _AmountService.getAgentCalculations.and.returnValue(Observable.of(new InputAmountServer()));
  _AmountService.getAirlineCalculations.and.returnValue(Observable.of(new InputAmountServer()));
  ...
  it('calculateTotalOnAmount', () => {
    ...
    _AmountService.setAirlineCalculations.and.returnValue(Observable.of(airline));
