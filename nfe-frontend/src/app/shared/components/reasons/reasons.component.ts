...
export class ReasonsComponent implements OnInit, OnChanges {
  ...
  @Input()
  formControlParentName: string;

  @Output()
  returnForm: EventEmitter<FormGroup> = new EventEmitter<FormGroup>();
  ...
  reactiveFormCreated(): boolean {
    return (
      this.formGroupParent != undefined &&
      this.formControlParentName != undefined
    );
  }
