...
import static org.iata.bsplink.refund.test.fixtures.ReasonFixtures.getReasons;
...
public class ReasonControllerTest {
    ...
    private static final String BASE_URI = "/v1/reasons/indirects";
    private static final String NON_EXISTENT_REASON_URI = "/v1/reasons/indirects/9999";
    ...
    @Test
    public void testListsReasonsByIsoCountryCodeAndType() throws Exception {
        ...
        List<Reason> filteredReasons = reasons.stream()
                .filter(r -> isoc.equals(r.getIsoCountryCode()) & type.equals(r.getType()))
                .collect(Collectors.toList());
        assertThat(actual, equalTo(filteredReasons));
    }
