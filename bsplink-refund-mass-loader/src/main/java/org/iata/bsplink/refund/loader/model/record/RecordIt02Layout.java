...
public class RecordIt02Layout extends RecordBaseLayout {
    ...
    protected void setFieldsLayout(Map<String, String> fieldsLayout) {
        ...
        fieldsLayout.put("stockControlNumberFrom1", "154-169");
        fieldsLayout.put("stockControlNumberFrom2", "183-198");
        fieldsLayout.put("stockControlNumberFrom3", "212-227");
        fieldsLayout.put("stockControlNumberTo1", "141-144");
        fieldsLayout.put("stockControlNumberTo2", "170-173");
        fieldsLayout.put("stockControlNumberTo3", "199-202");
        fieldsLayout.put("stockControlNumberTo4", "228-231");
